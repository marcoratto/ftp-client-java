...
public class ListenerException extends Exception {
	...
	public ListenerException(String s, Exception e) {
		super(s, e);
		logger.error(s, e);
	}
    ...
    public static ListenerException exactlyOne(String[] attrs) {
        return exactlyOne(attrs, null);
    }
	
    public static ListenerException exactlyOne(String[] attrs, String alt) {
        ...
        return new ListenerException(buf.append(" is required.").toString());
    }
